...
public class VarkalaResortAdapter extends RecyclerView.Adapter<VarkalaResortAdapter.ViewHolder> {
    Context context;
    List<VarkalaResortModel>varkalaResortModelList;


    public VarkalaResortAdapter(Context context, List<VarkalaResortModel> varkalaResortModelList) {
        this.context = context;
        this.varkalaResortModelList = varkalaResortModelList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.varkalaresort,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Glide.with(context).load(varkalaResortModelList.get(position).getImg_url()).into(holder.resImg);
        holder.name.setText(varkalaResortModelList.get(position).getName());
        holder.price.setText(varkalaResortModelList.get(position).getPrice());
        holder.rating.setText(varkalaResortModelList.get(position).getRating());
...
//        });
    ...
    public int getItemCount() {
        return varkalaResortModelList.size();
    }
